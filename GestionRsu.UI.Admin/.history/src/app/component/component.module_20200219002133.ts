...
import { CreateHolidayComponent, ExampleHeader} from './holiday/create-holiday/create-holiday.component';
...
@NgModule({
  ...
  entryComponents: [DialogOverviewExampleDialogComponent, CreateHolidayComponent, EditHolidayComponent, ExampleHeader],
  declarations: [
    FilterIsDeletedPipe,
